...
<script type="text/javascript">
	...
	function memberdel(){
		location.href = "views/member/secessionCheck.jsp?id=<%= loginMember.getId() %>";
	}
	
	function moveUpdateView(){
		//요청한 회원의 정보 수정페이지를 내보내는 서블릿을 요청함
		//다시 요청한 회원의 아이디를 전송해서 처리함
		location.href = "/nnd/passdate?id=<%= loginMember.getId() %>";
	}
...
<div id="ad_listview"> <!-- 전체 묶은 div : start -->	
	<h1 class="ad_pagetit"><span>My Page</span>마이 페이지</h1>	
	<div id="wrap">
		<div class="my_page">
			
			<div class="my_table">
				<table id="outer" align="center" width="500" cellspacing="5" cellpadding="0" class="w3-table-all w3-small">
					<caption><%= loginMember.getnName() %> 님의 회원정보 페이지입니다.</caption>
					<tr>
						<th width="220">아이디</th>
