...
public class TempInsertServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		int result = new PostService().tempInsertPost(post);
        ...
        response.setContentType("text/html; charset=UTF-8");
        PrintWriter out = response.getWriter();
        out.println("<script>alert('금지어가 포함된 편지는 저장할 수 없습니다.');document.location.href='views/post/postWriteForm.jsp';</script>");
        out.flush();
        out.close();
   }
