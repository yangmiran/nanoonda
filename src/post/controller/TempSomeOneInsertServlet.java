...
/**
 * Servlet implementation class TempSomeOneInsertServlet
 */
@WebServlet("/ptsoinsert")
public class TempSomeOneInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TempSomeOneInsertServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new PostService().TempSomeOneInsertServlet(post);
        ...
        response.setContentType("text/html; charset=UTF-8");
        PrintWriter out = response.getWriter();
        out.println("<script>alert('금지어가 포함된 편지는 저장할 수 없습니다.');document.location.href='views/post/someOneWriteForm.jsp';</script>");
        out.flush();
        out.close();
   }
